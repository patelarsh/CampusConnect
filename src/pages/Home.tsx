...
import { Rocket, Users, BookOpen, HelpCircle, GraduationCap, ChevronRight, Github, Twitter, Linkedin, Star, Shield, Zap } from 'lucide-react';
      ...
      <nav className="fixed top-0 w-full z-50 bg-white/80 backdrop-blur-md border-b border-slate-100">
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          <Link to="/" className="flex items-center gap-2.5 group">
            ...
            <img src="https://ashishvidhyalay.com/ADM/Connect%20(1).png" width="150px"/>
          </Link>
          ...
          <div className="flex items-center gap-4">
            {user ? (
              ...
              <>
                <Link to="/auth" className="hidden sm:block text-sm font-bold text-slate-900 hover:text-indigo-600 transition-colors">
                  Log in
                </Link>
                <Link
                  to="/auth"
